    ...
    <div className="relative bg-gradient-to-t from-blue-100 to-white pt-24">
      <div className="container mx-auto px-6 gap-10 flex flex-col max-w-7xl">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <button className="px-8 py-4 w-40 bg-blue-600 text-white text-lg rounded-sm font-medium hover:bg-blue-700 transition-colors shadow-lg">
            Get Started
          </button>
          <button className="px-8 py-4 w-40 border border-gray-300 hover:bg-gray-100 transition-colors bg-white text-gray-700 text-lg rounded-sm font-medium">
            Sign in
          </button>
        </div>
